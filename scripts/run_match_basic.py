...
algo1 = parent_dir + "\\python-algo\\run.ps1" if is_windows else parent_dir + "/python-algo/run.sh"
algo2 = parent_dir + "\\python-algo\\run_basic.ps1" if is_windows else parent_dir + "/python-algo/run_basic.sh"
